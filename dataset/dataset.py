...
from vtn_att_poseflow_model_dataset import VTN_ATT_PF_Dataset, VTN_GCN_Dataset
from vtn_hc_pf_three_view import VTNHCPF_ThreeViewsData,VTN3GCNData
from crossVTN_dataset import CrossVTN_Dataset, CrossViewVTN_Dataset
...
def build_dataset(dataset_cfg, split,model = None,**kwargs):
    ...
    if dataset_cfg['model_name'] == '2s-CrossViewVTN':
        dataset = CrossViewVTN_Dataset(dataset_cfg['base_url'],split,dataset_cfg,**kwargs)
